...
final class LoopScroll implements Runnable {
    ...
    LoopScroll(LoopView loopview, int offset) {
    ...
    public final void run() {
        ...
        if (Math.abs(realTotalOffset) <= 0) {
            ...
            loopView.handler.sendEmptyMessage(LoopMessageHandler.WHAT_ITEM_SELECTED);
        } else {
